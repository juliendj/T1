                ...
                <div class="collapse" id="sidebarDashboards">
                    <ul class="nav sub-navbar-nav">
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{route('equipe.equipe.index')}}"
                                >Liste des Equipe</a
                            >
                        </li>
                        <li class="sub-nav-item">
                            <a
                                class="sub-nav-link"
                                href="{{route('personel.personel.index')}}"
                                >Liste du personel</a
                            >
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{route('departement.departement.index')}}"
                                >Listes des Departements</a
                            >
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{route('information.information.index')}}"
